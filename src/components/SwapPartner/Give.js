...
const Give = ({
	...
	const getBattery = () => {
		...
		let defaulter = [ 8920743800, 8862959224, 9654484894, 8929297194, 8340614367, 6202157738, 7067903802, 7827404590, 9810214064, 9971231693, 9811582356, 8383818994, 9650869715, 7042824589, 8595704384, 7542856286, 7838227445, 7290801642, 9718769098, 7292082473, 9716841327 ]
		const station = document.querySelector("#station").value;
