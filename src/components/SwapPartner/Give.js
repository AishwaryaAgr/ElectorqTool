...
const Give = ({
	...
	const getBattery = () => {
		...
		let defaulter = [8434320940, 8700866802, 8929297194, 8287213520, 9958560763, , 9650313751, 8076345813, 7300973985, 9821642320, 6202157738, 9971231693, 9319661268, 9910934356, 9889691589]
		const station = document.querySelector("#station").value;
