...
const Give = ({
	...
	const getBattery = () => {
		...
		let defaulter = [ 8076345813, 8434320940, 9650313751, 9971848834, 9718862612, 6202157738, 8929297194,9889691589, 9599104057, 8969611448, 9654484894, 7838227445, 8595704384, 9811766238, 9971040622, 9958072077, 9650869715]
		const station = document.querySelector("#station").value;
