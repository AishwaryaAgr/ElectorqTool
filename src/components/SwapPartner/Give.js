...
const Give = ({
	...
	const getBattery = () => {
		...
		let defaulter = [8862959224, 9818707346, 8595154763, 8340614367, 9193070355, 7091229350, 9910934356 ,7067903802, 9118651707, 8076459175, 7428719664, 9811766238, 9810214064, 8076391917, 9560465535, 9971040622, 9958072077, 8383818994, 8368021998, 9509610407, 8595704384, 7542856286, 7838227445, 9534734424, 8969611448, 7217605364, 9718769098, 9892416148, 9508992967]
		const station = document.querySelector("#station").value;
