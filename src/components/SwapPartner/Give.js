...
const Give = ({
	...
	const getBattery = () => {
		...
		let defaulter = [ 9818707346, 7091229350, 9910934356 ,7067903802, 9118651707, 9810214064, 9971040622, 9958072077, 8383818994, 9509610407, 7542856286, 8969611448, 7217605364, 9718769098, 9892416148, 9508992967]
		const station = document.querySelector("#station").value;
