...
const Give = ({
	...
	const getBattery = () => {
		...
		let defaulter = [8076459175, 7827404590, 9717816216, 9910934356, 7291948678, 9599764693, 7488992785, 9818707346, 8920743800, 9971040622, 9958072077, 9650869715, 8368021998, 8882906756, 8585961062, 8595704384, 9118651707, 8368272361, 9534734424, 8862959224, 9650511375, 7217605364, 9810214064]
		const station = document.querySelector("#station").value;
