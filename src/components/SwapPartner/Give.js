...
const Give = ({
	...
	const getBattery = () => {
		...
		let defaulter = [ 8076345813, 8434320940, 9650313751, 9971848834, 9718862612,7292082473,  9971231693, 6202157738, 8929297194, 6268137343,9889691589, 9599104057, 8368255474, 7983353742, 7222002402, 7004333681, 8862959224, 8969611448, 8076459175, 9012130293, 9560465535, 9910934356, 9654484894, 7838227445, 8595704384, 9811766238, 9971040622, 9958072077, 8383818994, 9650869715]
		const station = document.querySelector("#station").value;
