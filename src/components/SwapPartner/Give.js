...
const Give = ({
	...
	const getBattery = () => {
		...
		let defaulter = [8076459175, 7827404590, 9599764693, 8595154763, 8920743800, 9717816216, 9650869715, 9971040622, 9958072077, 8882906756, 8595704384, 8969611448, 9118651707, 8862959224, 9650511375, 9810214064]
		const station = document.querySelector("#station").value;
